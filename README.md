...
| #   | Date        | Supervisors  |Activities                  | Progress       | Meet        | Notes |
|-----|-------------|--------------|----------------------------|----------------|-------------|-------|
|  1  | 2026-01-05  | Promotor     | Paper accepted dan persiapan presentasi konferensi - ISIBER 2026 | Selesai | Online | - |
...
| #  | Type        | Title  | Status | Publisher | Date | DOI |
|----|-------------|--------|--------|-----------|------| ------|
| 1  | Prosiding   | Performance Enhancement of Wireless Sensor Networks Using a Multi-Channel Gaussian Mixture Model | Published | IEEE | 16 April 2026 | [10.1109/ISIBER68248.2026.11469918](https://ieeexplore.ieee.org/abstract/document/11469918) |
